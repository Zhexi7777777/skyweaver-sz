...
def main():
    ...
    parser.add_argument("--days", type=int, default=5, help="获取过去几天+未来一天的数据 (默认5)")
    ...
    parser.add_argument("--accent", type=float, default=0.15, help="高光参数 0~1 (默认0.15)")
